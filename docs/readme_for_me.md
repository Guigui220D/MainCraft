...
As of now, I don't plan on making a working solo mode, but only a multiplayer client. That being said, when the hughmongus task of making a working client is done, the task of making a server will naturally come, and should integrate also as a solo mode (like I did for buildoland).

This is a project I've been wanting to do for very long, and I am intimidated to start it because the tasklist is very very long. I would already be super proud though, to even have Zig NBT decoded, protocol decoding, auth., etc...
