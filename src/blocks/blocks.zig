...
pub const table = [256]Block{
    ...
    .{ .name = "wood", .tex_id = 4 },
    .{ .name = "sapling", .tex_id = 15, .full_block = false, .hitbox = false },
    .{ .name = "bedrock", .tex_id = texpos(1, 1) },
    .{ .name = "water", .tex_id = texpos(15, 12), .full_block = false, .hitbox = false },
    .{ .name = "water", .tex_id = texpos(15, 12), .full_block = false, .hitbox = false },
    ...
    .{},
    .{},
    .{ .name = "tallgrass", .tex_id = texpos(7, 2), .full_block = false, .block_model = .plant, .uv_type = .plant, .hitbox = false },
    // 32
    .{ .name = "deadbush", .tex_id = texpos(7, 3), .full_block = false, .block_model = .plant, .uv_type = .plant, .hitbox = false },
    .{},
    .{},
    .{},
    .{},
    .{ .name = "flower", .tex_id = 13, .full_block = false, .block_model = .plant, .uv_type = .plant, .hitbox = false },
    .{ .name = "rose", .tex_id = 12, .full_block = false, .block_model = .plant, .uv_type = .plant, .hitbox = false },
    .{ .name = "mushroom", .tex_id = texpos(13, 1), .full_block = false, .block_model = .plant, .uv_type = .plant, .hitbox = false },
    .{ .name = "mushroom", .tex_id = texpos(12, 1), .full_block = false, .block_model = .plant, .uv_type = .plant, .hitbox = false },
    .{},
    .{},
    .{},
    .{},
